...
(function ($) {
    ...
    / 1. Revolution Slider
    ----------------------------------------------------------*/
    const slider1Length = jQuery('#rev_slider_1 > ul').children().length;
    ...
    const slider2Length = jQuery('#rev_slider_2 > ul').children().length;
    ...
    const slider3Length = jQuery('#rev_slider_3 > ul').children().length;
